        ...
        for interpretation in range(dvRange):
            ...
            if df1.iat[n, sign_n] == "**":
                if df1.iat[n, d0n] > df1.iat[n, d1n]:
                    st.write(
                        f'{iv}によって【'f'{dn}】には優位な差が生まれる'f'（{d0}＞'f'{d1}）')
                elif df1.iat[n, d0n] < df1.iat[n, d1n]:
                    st.write(
                        f'{iv}によって【'f'{dn}】には優位な差が生まれる'f'（{d1}＞'f'{d0}）')
                ...
                if df1.iat[n, d0n] > df1.iat[n, d1n]:
                    st.write(
                        f'{iv}によって【'f'{dn}】には優位な差が生まれる傾向にある'f'（{d0}＞'f'{d1}）')
                elif df1.iat[n, d0n] < df1.iat[n, d1n]:
                    st.write(
                        f'{iv}によって【'f'{dn}】には優位な差が生まれる傾向にある'f'（{d1}＞'f'{d0}）')
            elif df1.iat[n, sign_n] == "n.s.":
                st.write(f'{iv}によって【'f'{dn}】には優位な差が生まれない')
